...
function en_107(o) { return [107,o.v.length>>>8,o.v.length&255,o.v];}
function en_104(o) { var l=o.v.length,r=[]; for(var i=0;i<l;i++)r.push(ein(o.v[i]));
                     return [104,l,r]; }
function en_109(o) { var l=o.v.length;return[109,l>>>24,l>>>16&255,l>>>8&255,l&255,o.v]; }
function en_108(o) { var l=o.v.length,r=[]; for(var i=0;i<l;i++)r.push(ein(o.v[i]));
                     return[108,l>>>24,(l>>>16)&255,(l>>>8)&255,l&255,r,106];}
...
function run(b) { var i=sz=b==1?sx.getUint8(ix):sx.getUint32(ix),r=[]; ix+=b;
