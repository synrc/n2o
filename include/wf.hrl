...
-record(cx,      {handlers, actions, req, module, path, session, params, form}).
...
-define(ELEMENT_BASE(Module,Tag,Delegate),
        ...
        html_tag=Tag, title, postback, accesskey, 
        contenteditable, contextmenu, dir,
        draggable, dropzone, hidden, lang, spellcheck, translate, onafterprint,
        onbeforeprint, onbeforeunload, onblur, onerror, onfocus, onhashchange,
