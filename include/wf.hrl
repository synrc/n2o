...
-record(upload, {?ELEMENT_BASE(element_upload), name, delegate_query, delegate, root=code:priv_dir(n2o), dir="", post_write, img_tool, preview=false}).
...
-record(htmlbox, {?ELEMENT_BASE(element_htmlbox), html="", script_url="static/tinymce/tinymce.min.js", theme="n2o", delegate, toolbar_class, toolbar_script, root=code:priv_dir(n2o), dir="", post_write, img_tool}).
