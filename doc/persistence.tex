...
Any data in KVS is represented using regular Erlang records.
...
Depending on database the format and/or featureset may differ. join/1 function
is for initializing database replicated from remote node along with its shema.
...
This API allows you to builds forms from table metainfo.
Also you can use this api for metainfo introspection.
...
get/3 API is used for specifying default value.
...
This API you can use for storing all database
in single file when this is possible. It is rather development API.
