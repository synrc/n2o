...
info(#ftp{sid=Sid,status= <<"init">>, offset=Size, block=B, data=Msg}=FTP, Req, State) ->
    ...
    F2 = FTP#ftp{block = Block, offset = Offset, data = <<>>, filename = Name},
