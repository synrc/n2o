...
export function tuple() { return { t: 104, v: Array.apply(null, arguments) }; }
export function list() { return { t: 108, v: Array.apply(null, arguments) }; }
export function map() { return { t: 116, v: Array.apply(null, arguments) }; }
export function atom(o) { return { t: 100, v: utf8_enc(o) }; }
export function string(o) { return { t: 107, v: utf8_enc(o) }; }
export function float(o) { return { t: 70, v: o }; }
export function number(o) {
  const isInteger = (o % 1 === 0);
  if (isInteger && o >= 0 && o < 256) { return { t: 97, v: o };  }
  if (isInteger && o >= -134217728 && o <= 134217727) { return {t: 98, v: o}; }
  return {t: 110, v: o}; }
export function bin(o) {
  return { t: 109, v: o instanceof ArrayBuffer ? new Uint8Array(o) :
                      o instanceof Uint8Array  ? o : utf8_enc(o) }; }

// ENCODER

export function enc(o) { return fl([131, ein(o)]); }
export function ein(o) { return Array.isArray(o) ? en_108({ t: 108, v: o }) : eval('en_' + o.t)(o); }
export function en_undefined(o) { return [106]; }
export function en_70(o) {
  var x = Array(8).fill(0).flat();
  write_Float(x,o.v,0,false,52,8);
  return [70].concat(x);
}
export function en_97(o) { return [97, o.v]; }
export function en_98(o) { return [98, o.v >>> 24, (o.v >>> 16) & 255, (o.v >>> 8) & 255, o.v & 255]; }
export function en_99(o) {
...
export function en_106(o) { return [106]; }
export function en_115(o) { return [115, o.v.length, ar(o)]; }
export function en_119(o) { return [119, ar(o).length, ar(o)]; }
export function en_118(o) { return [118, ar(o).length >>> 8, ar(o).length & 255, ar(o)]; }
export function en_100(o) { return [100, o.v.length >>> 8, o.v.length & 255, ar(o)]; }
export function en_107(o) { return [107, o.v.length >>> 8, o.v.length & 255, ar(o)]; }
export function en_104(o) {
  var l = o.v.length, r = [];
  for (var i = 0; i < l; i++)r[i] = ein(o.v[i]);
  return [104, l, r];
}
export function unilen(o) {
  return (o.v instanceof ArrayBuffer || o.v instanceof Uint8Array) ? o.v.byteLength :
         (new TextEncoder().encode(o.v)).byteLength;
}

export function en_109(o) {
  var l = unilen(o);
  return [109, l >>> 24, (l >>> 16) & 255, (l >>> 8) & 255, l & 255, ar(o)];
}
export function en_108(o) {
  var l = o.v.length, r = [];
  for (var i = 0; i < l; i++)r.push(ein(o.v[i]));
  return o.v.length === 0 ? [106] :
         [108, l >>> 24, (l >>> 16) & 255, (l >>> 8) & 255, l & 255, r, 106];
}
export function en_116(o) {
...
export function en_110(o) {
  var s=int_to_bytes(o.v); return [110,s.length,(o.v<0)?1:0].concat(s);
}

// DECODER

export function nop(b) { return []; };
export function big(b) {
